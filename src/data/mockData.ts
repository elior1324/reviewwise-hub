...
export const COURSES: Course[] = [
  { id: "course-1", businessSlug: "digital-marketing-academy", name: "שיווק דיגיטלי מאסטרקלאס", price: 2490, description: "קורס מקיף בשיווק דיגיטלי הכולל SEO, Google Ads, רשתות חברתיות ואנליטיקס.", affiliateUrl: "https://dma.co.il/masterclass", category: "שיווק", rating: 4.8, reviewCount: 58, verifiedPurchases: 312 },
  { id: "course-2", businessSlug: "digital-marketing-academy", name: "יסודות SEO", price: 990, description: "למדו לדרג אתרים בגוגל מאפס. קורס מעשי עם תרגילים.", affiliateUrl: "https://dma.co.il/seo", category: "שיווק", rating: 4.5, reviewCount: 34, verifiedPurchases: 189 },
  { id: "course-3", businessSlug: "digital-marketing-academy", name: "הסמכת Google Ads", price: 1790, description: "הכנה מלאה להסמכת Google Ads עם פרויקטים אמיתיים.", affiliateUrl: "https://dma.co.il/google-ads", category: "שיווק", rating: 4.7, reviewCount: 22, verifiedPurchases: 145 },
  { id: "course-4", businessSlug: "digital-marketing-academy", name: "אנליטיקס מתקדם", price: 1490, description: "ניתוח נתונים מתקדם עם Google Analytics 4 ו-Data Studio.", affiliateUrl: "https://dma.co.il/analytics", category: "שיווק", rating: 4.3, reviewCount: 10, verifiedPurchases: 78 },
  { id: "course-5", businessSlug: "code-masters-il", name: "בוטקמפ Full-Stack", price: 14900, description: "12 שבועות אינטנסיביים של React, Node.js, PostgreSQL ועוד.", affiliateUrl: "https://codemasters.co.il/fullstack", category: "תכנות", rating: 4.6, reviewCount: 62, verifiedPurchases: 234 },
  { id: "course-6", businessSlug: "code-masters-il", name: "React מתקדם", price: 3490, description: "Hooks, Context, Redux, Next.js ודפוסי עיצוב מתקדמים.", affiliateUrl: "https://codemasters.co.il/react", category: "תכנות", rating: 4.7, reviewCount: 27, verifiedPurchases: 156 },
  { id: "course-7", businessSlug: "design-school-tlv", name: "יסודות עיצוב UI/UX", price: 3990, description: "מחקר משתמשים, Wireframing, Figma ופרויקט גמר.", affiliateUrl: "https://designtlv.co.il/uiux", category: "עיצוב", rating: 4.9, reviewCount: 45, verifiedPurchases: 201 },
  { id: "course-8", businessSlug: "data-science-hub", name: "Python למדעי נתונים", price: 2990, description: "מ-Python בסיסי ועד Pandas, NumPy ו-Matplotlib.", affiliateUrl: "https://datahub.co.il/python", category: "מדעי נתונים", rating: 4.7, reviewCount: 89, verifiedPurchases: 445 },
  { id: "course-9", businessSlug: "data-science-hub", name: "למידת מכונה מתקדמת", price: 4990, description: "TensorFlow, PyTorch, NLP ו-Computer Vision.", affiliateUrl: "https://datahub.co.il/ml", category: "מדעי נתונים", rating: 4.8, reviewCount: 67, verifiedPurchases: 289 },
  { id: "course-10", businessSlug: "growth-academy", name: "Growth Hacking", price: 1990, description: "אסטרטגיות צמיחה מהירה לסטארטאפים.", affiliateUrl: "https://growth.co.il/hacking", category: "עסקים", rating: 4.4, reviewCount: 31, verifiedPurchases: 112 },
];
...
export const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    courseName: "אנליטיקס מתקדם", courseId: "course-4", businessSlug: "digital-marketing-academy",
  ...
  },
  {
    ...
    courseName: "Growth Hacking", courseId: "course-10", businessSlug: "growth-academy",
