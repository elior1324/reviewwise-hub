...
// Source: serafimcloud/testimonial-card — verbatim with ReviewHub path conventions.
// Avatar and AvatarImage come from the existing shadcn Avatar already in this project.
