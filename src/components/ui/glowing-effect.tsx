...
//   </div>
//
// The GlowingEffect div must be a direct child of the container that has
// `position: relative` and `border-radius` set (rounded-* class).  The inner
// content div also needs `position: relative` so it sits above the glow layer.
