...
const REVIEWHUB_SOCIALS = [
  { Icon: Instagram, label: "Instagram", url: "https://instagram.com/reviewhub" },
  { Icon: WhatsAppIcon, label: "WhatsApp", url: "https://wa.me/972000000000" },
  { Icon: Facebook, label: "Facebook", url: "https://facebook.com/reviewhub" },
  { Icon: Twitter, label: "X", url: "https://x.com/reviewhub" },
  { Icon: Linkedin, label: "LinkedIn", url: "https://linkedin.com/company/reviewhub" },
    ...
    <div className="container py-12">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            <Link to="/business/resources" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">תיעוד ובלוג</Link>
