    ...
    <section className="container py-16 md:py-24">
      ...
      <ul className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2">
        ...
        <GridItem
          ...
          description={
            <>
              כל ביקורת שנספרת בדירוג קשורה לרכישה ממשית — אומתה מול
        ...
        <GridItem
          ...
          description={
            <>
              <strong>דירוג כוכבים</strong> — ממוצע ביקורות מאומתות רכישה מכל המקורות.{" "}
              <strong>תג האמון</strong> — מציג את עומק האימות: כמה ביקורות עברו אימות ואיזה אחוז מהסך.{" "}
