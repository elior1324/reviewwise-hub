    ...
    <section className="container py-16 md:py-24">
      ...
      <ul className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2">
        ...
        <GridItem
          ...
          description={
            <>
              כל ביקורת שנספרת בדירוג קשורה לרכישה ממשית — מגיעה דרך קישור
              ייחודי חד-פעמי שהעסק יצר, ועוברת בדיקה לפני פרסום.{" "}
              <strong>ביקורת שלא עברה תהליך זה מוצגת בנפרד ואינה נספרת.</strong>
            </>
          }
        />
        ...
        <GridItem
          ...
          title="דירוג + תג אמון — שתי שכבות נפרדות"
          description={
            <>
              <strong>דירוג כוכבים</strong> — ממוצע ביקורות שעברו בדיקה ואושרו מכל המקורות.{" "}
              <strong>תג השקיפות</strong> — מציג את עומק הבדיקה: כמה ביקורות נבדקו ואיזה אחוז מהסך.{" "}
              שתי שכבות עצמאיות — לא מעורבבות.
            </>
          }
        />
        ...
        <GridItem
          ...
          description={
            <>
              ...
              <strong>ציון אמון ונפח ביקורות שנבדקו</strong>,
