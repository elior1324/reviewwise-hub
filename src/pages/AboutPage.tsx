...
import {
  ShieldCheck, Users, Award, TrendingUp,
  CheckCircle, XCircle, Sparkles, ShieldAlert,
} from "lucide-react";
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container py-24 md:py-32 relative">
          <motion.div className="max-w-3xl mx-auto text-center" initial="hidden" animate="visible">
            ...
            >
              <ShieldCheck size={16} /> פלטפורמת שקיפות עצמאית
            </motion.div>
            <motion.h1
              variants={fadeUp}
              custom={1}
            ...
            >
              ביקורות אמיתיות.{" "}
              <span className="gradient-text glow-text">החלטות מבוססות.</span>
            </motion.h1>
            <motion.p
              variants={fadeUp}
              custom={2}
            ...
            >
              ReviewHub מרכזת ביקורות על מוצרים, קורסים ושירותים דיגיטליים ומציגה
              אותן בצורה שקופה — כדי שתוכלו להחליט על בסיס מידע אמיתי, לא שיווק.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="container py-20">
        ...
        >
          ...
          <motion.div variants={fadeUp} custom={1} className="space-y-4 text-foreground/80 leading-relaxed">
            <p>
              ReviewHub מרכזת חוות דעת משתמשים ממקורות מרובים — ביקורות שנכתבו ישירות
              בפלטפורמה, משוב שהגיע דרך WhatsApp, וביקורות שיובאו מ-Google.
            </p>
            <p>
              כל ביקורת מסומנת לפי המקור שלה ולפי רמת האימות — כדי שתוכלו לדעת
              בדיוק על מה אתם מסתמכים.
            </p>
            <p>
              כשאתם רוכשים מוצר או שירות דרך ReviewHub, אתם עשויים לקבל הנחה
              בלעדית מבעל העסק — כי הוא יודע שלקוחות שמגיעים מכאן כבר עשו את
              הבדיקה שלהם.
            </p>
          </motion.div>
        </motion.div>
          ...
          >
            ...
            <motion.div variants={fadeUp} custom={1} className="space-y-5 text-foreground/80 leading-relaxed">
              ...
              <p>
                ...
                אחד יכול לכתוב כל דבר. ביקורות מגיעות דרך קישורים ייחודיים שהעסק יצר, ועוברות
                בדיקה לפני פרסום. ביקורות שלא עברו תהליך זה מסומנות בצורה ברורה.
              </p>
              <p>
                אנחנו <strong className="text-foreground">לא</strong> שותפים עסקיים של היוצרים
                שאנחנו מדרגים. ReviewHub פועלת כשכבת שקיפות עצמאית — ציוני האמון מחושבים
                מנתוני ביקורות בלבד. קישורי רכישה מסומנים בגילוי נאות ברור.
              </p>
            </motion.div>
          </motion.div>
        </div>
            ...
            {[
              {
                icon: ShieldCheck,
                title: "בדיקה עצמאית",
                desc: "ביקורות מגיעות דרך קישורים ייחודיים שהעסק יצר, ועוברות בדיקת תוכן לפני פרסום — לא על בסיס הצהרת הלקוח ולא על בסיס הצהרת היוצר.",
              },
              {
                icon: Users,
              ...
              },
              {
                ...
                desc: "ציון האמון מחושב אוטומטית מנתוני ביקורות. אין אפשרות לרכוש ציון גבוה יותר, לשלם על מיקום עדיף, או להסיר נתון לא נוח.",
              },
              {
                icon: TrendingUp,
                title: "שקיפות עקרונית",
                desc: "הגורמים שמרכיבים את ציון האמון מוצגים בגלוי. אנחנו מפרסמים את מה שאנחנו בודקים — ואת הגבולות של מה שאנחנו יכולים למדוד.",
              },
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                {
                  title: "עצמאות",
                  desc: "ציוני האמון אינם מושפעים מיחסים עסקיים. אין יוצר שיכול לרכוש דירוג.",
                },
                {
                  title: "שקיפות",
                  desc: "האותות שמרכיבים את הציון מפורסמים. כשאנחנו לא יודעים משהו — אנחנו אומרים את זה.",
                },
                {
      ...
      <section className="container py-20">
        ...
        >
          ...
          <motion.p variants={fadeUp} custom={1} className="text-muted-foreground mb-8 leading-relaxed">
            כל עסק מקבל ציון אמון (0–100) שמתורגם לדרגה. הציון מחושב אוטומטית
            מביקורות שנבדקו — ולא ניתן להשפעה בכסף.
          </motion.p>
          ...
          >
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              מנגנוני זיהוי אוטומטיים בודקים דפוסי ביקורות חשודים. ספק שמופנה
              לחקירה מסומן בגלוי בפרופיל שלו. ציונים שהתגלתה בהם פעילות לא תקינה
              מתוקנים בהתאם.
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="relative">
            ...
            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
              עיינו בציוני האמון, קראו ביקורות שנבדקו, והחליטו על בסיס מידע אמיתי — לא על בסיס
              שיווק.
            </p>
