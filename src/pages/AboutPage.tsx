      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container py-24 md:py-32 relative">
          <motion.div className="max-w-3xl mx-auto text-center" initial="hidden" animate="visible">
            ...
            >
              ReviewHub היא פלטפורמה שמטרתה לשפר את איכות המידע סביב מוצרים, קורסים ושירותים דיגיטליים.
              המערכת מרכזת חוות דעת משתמשים ומציגה אותן בצורה שמאפשרת להבין טוב יותר את חוויית הלקוחות בפועל.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="container py-20">
        ...
        >
          ...
          <motion.div variants={fadeUp} custom={1} className="space-y-4 text-foreground/80 leading-relaxed">
            ...
            <p>
              הפלטפורמה פועלת ליצירת סביבה שקופה יותר, המאפשרת להעריך אמינות ולקבל החלטות על בסיס מידע רחב ומבוסס יותר.
            </p>
          </motion.div>
        </motion.div>
      </section>
          ...
          >
            ...
            <motion.div variants={fadeUp} custom={1} className="space-y-5 text-foreground/80 leading-relaxed">
              ...
              <p>
                ...
                שאנחנו מדרגים. ReviewHub פועלת כשכבת שקיפות עצמאית — ציוני השקיפות, מדדי הנראות,
                ומשקל הפרופיל בפלטפורמה מחושבים מנתוני ביקורות בלבד. קישורי רכישה מסומנים בגילוי
                נאות ברור, ועמלות התפעול משמשות אך ורק לתחזוקת תשתית הפלטפורמה.
              </p>
            </motion.div>
          </motion.div>
        </div>
            ...
            {[
              {
                icon: ShieldCheck,
                title: "בדיקה עצמאית",
                desc: "ביקורות מגיעות דרך קישורים ייחודיים שהעסק יצר, ועוברות בדיקת תוכן לפני פרסום — לא על בסיס הצהרת הלקוח ולא על בסיס הצהרת היוצר. המטרה היא לשמור על רמת מידע אמינה ושקופה.",
              },
              {
                icon: Users,
      ...
      <section className="container py-20">
        ...
        >
            ...
            {[
              {
                ...
                desc: "ביקורות שעברו בדיקה ואושרו הן הבסיס לכל ציון. ביקורת מקבלת משקל רק לאחר שהגיעה דרך הערוץ המאומת ועברה בדיקה. עוצמת הציון גדלה עם עומק ועקביות הפעילות — ביקורת בודדת, חיובית ככל שתהיה, אינה מספיקה לציון גבוה.",
              },
              {
                icon: TrendingUp,
                label: "בריאות מסחרית",
          ...
          >
            ...
            ספק שהצטרף לאחרונה ויש לו מספר קטן של ביקורות שנבדקו יוצג עם הסימון{" "}
        ...
        <div className="container py-20">
          ...
          >
            ...
            <motion.p variants={fadeUp} custom={1} className="text-muted-foreground mb-8 leading-relaxed">
              ביקורות שנבדקו ואושרו הן לא רק נתונים לצרכן — הן המנוע שמניע את כל האקוסיסטם. פעילות
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              {[
                {
                  icon: Star,
                  title: "ביקורת שנבדקה ואושרה",
                  desc: "כתבתם ביקורת על רכישה שביצעתם — הביקורת עוברת בדיקה ומחזקת את תמונת האמינות של העסק שדירגתם.",
                ...
                },
                {
                  ...
                  desc: "כל ביקורת שנבדקה ואושרה מחזקת את אותות האמינות של העסק — יותר ביקורות עקביות לאורך זמן מייצרות ציון שקיפות חזק ומהימן יותר.",
            ...
            >
              ...
              ציוני השקיפות נבנים מפעילות בדוקה של לומדים אמיתיים. מסע הנקודות נבנה מהפניית
        ...
        >
          <div className="relative">
            ...
            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
              עיינו בציוני השקיפות, קראו ביקורות שנבדקו, והחליטו על בסיס מידע רחב ומבוסס — לא על בסיס
              שיווק.
            </p>
