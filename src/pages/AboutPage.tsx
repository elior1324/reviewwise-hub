        ...
        <div className="container py-20">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="max-w-3xl mx-auto">
            ...
            <motion.div variants={fadeUp} custom={1} className="rounded-xl border border-border/50 bg-card/60 p-6 space-y-4 text-foreground/80 leading-relaxed">
              <p>
                ReviewHub פועלת כפלטפורמת ביקורות ואימות עצמאית — ללא תלות ביוצרי קורסים.
              </p>
              <p>
                כדי לספק ערך מוסף לקהילת הלומדים, ReviewHub הבטיחה <strong className="text-foreground">הנחה קבועה של 10%</strong> על רכישות המתבצעות דרך הפלטפורמה. כאשר מתבצעת רכישה דרך ReviewHub, המערכת מקבלת אות טכני המאפשר לאמת את העסקה ולהבטיח שביקורות עתידיות יישאו סטטוס <span className="text-primary font-medium">״קונה מאומת״</span>.
              </p>
              <p>
                <strong className="text-foreground">עמלת התפעול</strong> הנוצרת מעסקאות אלו תומכת בתחזוקת תשתית האימות ואינה משפיעה על ציון האמון של הפלטפורמה בשום צורה. ציון האמון נקבע אך ורק על בסיס משוב לומדים ונתוני הפלטפורמה.
              </p>
              <p className="text-sm text-muted-foreground border-t border-border/40 pt-3">
                <strong className="text-foreground">עמלות תפעול אלו אינן משפיעות על ציון האמון של הפלטפורמה.</strong> דירוגים ומדדי אמון נקבעים אך ורק על בסיס משוב לומדים, אותות רכישה מאומתת, מדדי החזרות ונתוני פלטפורמה לאורך זמן.
              </p>
            </motion.div>
          </motion.div>
        </div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="max-w-3xl mx-auto">
            ...
            <motion.div variants={fadeUp} custom={1} className="space-y-5 text-foreground/80 leading-relaxed">
              ...
              <p>
                ...
                ReviewHub פועלת כשכבת אימות עצמאית — קישורי רכישה מסומנים בגילוי נאות ברור, ועמלות התפעול משמשות אך ורק לתחזוקת תשתית האימות. ציון האמון נשאר בלתי תלוי לחלוטין.
              </p>
            </motion.div>
          </motion.div>
        </div>
