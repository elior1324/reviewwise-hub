  ...
  },
  {
    ...
    body: [
      ...
      { type: "list", items: [
        ...
        "נקודות אמון — חישוב נקודות מוניטין (ללא ערך כספי)",
  ...
  return (
    <div className="border border-border/50 rounded-2xl overflow-hidden bg-card/50">
      ...
      >
        ...
        <ChevronDown size={16} className={`text-muted-foreground/60 transition-transform duration-200 shrink-0 ml-4 ${open ? "rotate-180" : ""}`} />
      </button>
    ...
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      <main className="container max-w-2xl py-16">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-sm">עודכן לאחרונה: {META.updated} · חל על כלל משתמשי {META.company}</p>
        </motion.div>
