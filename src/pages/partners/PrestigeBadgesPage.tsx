...
/** Widget preview props — no fake data; shows the widget in its clean empty state */
...
const WIDGET_FEATURES = [
  ...
  { icon: "🔒", title: "ביקורות שנבדקו",    body: "כל ביקורת עוברת בדיקה לפני פרסום — ללא ספאם." },
...
function WidgetsTab({ ownerBusiness }: WidgetsTabProps) {
  ...
  const previewProps: Omit<TrustWidgetProps, "variant"> = ownerBusiness
    ? {
        ...
        reviews:      [], // reviews load via the iframe embed on the owner's site
      }
    : DEMO_WIDGET_PROPS;
