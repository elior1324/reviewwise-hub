        ...
        <div className="container py-20">
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            {[
              ...
              { q: "איך יוצרים קשר?", a: "לשאלות מהירות — השתמשו בצ'אטבוט ה-AI שלנו (הכפתור למטה). ליצירת קשר אנושית — שלחו מייל ל-reviewhub.il@gmail.com. במקצועי — תמיכה בעדיפות (מענה תוך 4 שעות), בפרימיום — מנהל הצלחה אישי." },
            ].map(({ q, a }, i) => (
              <motion.div
                key={i}
                initial="hidden"
