        ...
        <div className="container py-20">
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            {[
              ...
              { q: "מה ההבדל בין התוכניות?", a: "סטארטר — חינם, פרופיל בסיסי ועד 10 ביקורות. מקצועי — ביקורות ללא הגבלה, דאשבורד אנליטיקס, וידג'טים, אפיליאט ודוחות AI שבועיים. פרימיום — כל מה שבמקצועי + CRM, API, Webhook, דוחות AI יומיים ומנהל הצלחה אישי." },
