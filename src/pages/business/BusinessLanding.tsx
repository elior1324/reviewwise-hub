        ...
        <div className="container py-20">
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            {[
              ...
              { q: "כמה עולה להירשם?", a: "יש תוכנית חינמית שכוללת פרופיל בסיסי, עד 10 ביקורות בחודש ותגובות. תוכניות מתקדמות: מקצועי (₪189/חודש) ופרימיום (₪389/חודש) עם פיצ'רים מתקדמים." },
              { q: "מה ההבדל בין התוכניות?", a: "סטארטר — חינם, פרופיל בסיסי ועד 10 ביקורות. מקצועי — עסק אחד לחשבון, ביקורות ללא הגבלה, דאשבורד אנליטיקס, וידג'טים, אפיליאט ודוחות AI שבועיים. פרימיום — כל מה שבמקצועי + עסקים ללא הגבלה, CRM, API, Webhook, דוחות AI יומיים ומנהל הצלחה אישי." },
              { q: "יש תקופת ניסיון?", a: "כן! תוכנית מקצועי כוללת 14 ימי ניסיון חינם. תוכלו לבטל בכל עת ללא חיוב." },
              { q: "איך מאמתים שהביקורת אמיתית?", a: "אימות רכישה מתבצע דרך: (1) חשבונית/אישור תשלום שהלקוח מעלה, (2) אימות אוטומטי מול מערכת התשלומים, (3) קישור ביקורת ייעודי שנשלח רק ללקוחות שרכשו. ביקורות מאומתות מסומנות ב-✅." },
              { q: "איך אני שולח בקשות ביקורת ללקוחות?", a: "מלוח הבקרה, גשו ל'בקשות ביקורת'. תוכלו לשלוח קישור אישי ללקוח ספציפי, או להעלות קובץ CSV עם רשימת לקוחות לשליחה המונית. כל לקוח יקבל קישור ייחודי." },
              { q: "מה קורה אם לקוח כותב ביקורת שלילית?", a: "ביקורת שלילית היא הזדמנות לשיפור! תוכלו להגיב באופן מקצועי, להראות שאכפת לכם ולתקן. מחקרים מראים שתגובה מקצועית לביקורת שלילית דווקא מגבירה אמון." },
              { q: "אפשר למחוק ביקורת שלילית?", a: "לא, אנחנו לא מאפשרים מחיקת ביקורות. זה מבטיח אמינות. אם ביקורת מפרה את הכללים (לשון הרע, תוכן פוגעני, ביקורת מזויפת), תוכלו לדווח עליה ונבדוק תוך 24-48 שעות." },
              { q: "איך עובד הדאשבורד?", a: "הדאשבורד מציג: דירוג ממוצע, מגמות לאורך זמן, ביקורות אחרונות, אחוזי מענה, סטטיסטיקות קליקים והמרות. במקצועי ומעלה תקבלו גרפים ונתונים מפורטים." },
              { q: "מה זה מערכת אפיליאט?", a: "מערכת האפיליאט (זמינה במקצועי ומעלה) מייצרת קישורי הפניה ייחודיים לקורסים/שירותים שלכם. אתם מקבלים עמלה של 10% על כל מכירה שנכנסת דרך ReviewHub, ויכולים לעקוב אחרי קליקים, המרות והכנסות." },
              { q: "איך מטמיעים וידג'ט באתר שלי?", a: "מלוח הבקרה, גשו ל'וידג'טים'. תקבלו קוד HTML/JavaScript פשוט — פשוט הדביקו אותו באתר שלכם. הוידג'ט מציג את הדירוג והביקורות ומתעדכן אוטומטית." },
              { q: "מה כולל דוח ה-AI?", a: "דוח ה-AI מנתח את כל הביקורות שלכם ומזהה: חוזקות עיקריות, חולשות שצריך לשפר, מגמות לאורך זמן, פערי מכירות, והמלצות קונקרטיות לצמיחה — מבוסס על סנטימנט ונתוני קליקים. במקצועי: שבועי, בפרימיום: יומי." },
              { q: "האם ReviewHub עוזרת ב-SEO?", a: "כן! הפרופיל שלכם מאונדקס ב-Google, ביקורות חיוביות מחזקות את הנוכחות החיפושית. במקצועי ומעלה — תמיכת SEO מתקדמת וגילוי AI. בפרימיום — Google Ads Review Stars שמציג כוכבי דירוג ישירות במודעות." },
              { q: "אפשר לחבר CRM?", a: "כן, בתוכנית פרימיום! תוכלו לחבר HubSpot, Salesforce ומערכות נוספות. כל ביקורת חיובית יכולה להפוך אוטומטית לליד במערכת ה-CRM שלכם." },
              { q: "יש API?", a: "כן, בתוכנית פרימיום תקבלו גישת API מלאה: שליפת ביקורות, שליחת בקשות, נתוני אנליטיקס וניהול פרופיל — הכל אוטומטית מהמערכות שלכם." },
              { q: "מה זה Webhook?", a: "Webhook (זמין בפרימיום) מאפשר לחבר את ReviewHub ל-Zapier, Make (Integromat), או כל מערכת חיצונית. תקבלו התראות אוטומטיות על ביקורות חדשות, שינויים בדירוג ועוד." },
              { q: "איך אני מגיב לביקורת?", a: "מלוח הבקרה, תראו את כל הביקורות. ליד כל ביקורת יש כפתור 'הגב'. התגובה תופיע מתחת לביקורת בפרופיל שלכם. טיפ: הגיבו גם לביקורות חיוביות!" },
              { q: "איך אני מעלה לוגו ומתאים את הפרופיל?", a: "מלוח הבקרה, גשו ל'הגדרות פרופיל'. תוכלו להעלות לוגו, לערוך תיאור, להוסיף פרטי קשר, ולחבר רשתות חברתיות (YouTube, Instagram, TikTok, LinkedIn, Facebook ואתר)." },
              { q: "כמה ביקורות אפשר לקבל?", a: "בתוכנית סטארטר — עד 10 ביקורות בחודש. בתוכניות מקצועי ופרימיום — ביקורות ללא הגבלה." },
              { q: "אפשר לבטל את המנוי?", a: "כן, תוכלו לבטל בכל עת מלוח הבקרה. לאחר הביטול, החשבון ירד לתוכנית סטארטר. כל הביקורות שנאספו נשמרות, אך חלק מהפיצ'רים ייחסמו." },
              { q: "איך מקבלים יותר ביקורות?", a: "טיפים: (1) שלחו בקשות מיד אחרי מתן השירות, (2) הקלו על הלקוח — שלחו קישור ישיר, (3) הגיבו לכל ביקורת, (4) הוסיפו וידג'ט באתר שלכם, (5) שתפו ביקורות חיוביות ברשתות החברתיות." },
              { q: "מה ההבדל בין ReviewHub לאתרי ביקורות אחרים?", a: "הייחוד שלנו הוא באימות רכישות — כל ביקורת נבדקת. בנוסף: מערכת אפיליאט מובנית, דוחות AI, וידג'טים להטמעה, ומיקוד בשוק הישראלי עם ממשק מלא בעברית." },
              { q: "האם המידע שלי מאובטח?", a: "בהחלט. אנחנו משתמשים בהצפנת SSL, גיבויים יומיים, ועומדים בתקני אבטחת מידע. המידע העסקי שלכם מוגן ולא משותף עם צד שלישי." },
              { q: "אפשר לנהל כמה עסקים מחשבון אחד?", a: "כרגע כל חשבון מחובר לעסק אחד. אם יש לכם כמה עסקים, צרו חשבון נפרד לכל אחד. בפרימיום, מנהל ההצלחה יכול לעזור בניהול מרוכז." },
              { q: "איך הלקוחות שלי יודעים שאפשר לכתוב ביקורת?", a: "שלחו להם קישור ביקורת ייעודי (דרך בקשות ביקורת), הטמיעו וידג'ט באתר שלכם, או שתפו את קישור הפרופיל שלכם ב-ReviewHub." },
              { q: "מה התמיכה שמקבלים?", a: "סטארטר — תמיכה באימייל. מקצועי — תמיכה בעדיפות עם מענה תוך 4 שעות בימי עבודה. פרימיום — מנהל הצלחה אישי + תמיכה מיידית." },
              { q: "האם אפשר לראות מי כתב כל ביקורת?", a: "ביקורות שאינן אנונימיות מציגות את שם התצוגה של הכותב. ביקורות אנונימיות לא חושפות שמות, אך אימות הרכישה נשמר." },
              { q: "מה קורה אם לקוח לא קיבל את הקישור?", a: "תוכלו לשלוח שוב מלוח הבקרה: גשו ל'בקשות ביקורת', מצאו את הלקוח ולחצו 'שלח שוב'. אפשר גם ליצור קישור חדש ולשלוח ידנית." },
              { q: "איך מוסיפים קורס או שירות חדש?", a: "מלוח הבקרה, גשו ל'ניהול קורסים/שירותים' ולחצו 'הוסף חדש'. מלאו שם, תיאור, מחיר, קטגוריה וקישור אפיליאט (אם רלוונטי)." },
              { q: "איך יוצרים קשר עם הצוות?", a: "דרך עמוד יצירת קשר, דרך הצ'אטבוט שלנו (הכפתור למטה), או באימייל. במקצועי — תמיכה בעדיפות, בפרימיום — מנהל הצלחה אישי." },
            ].map(({ q, a }, i) => (
              <motion.div
                key={i}
                initial="hidden"
