        ...
        <div className="container py-20">
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            {[
              ...
              { q: "איך יוצרים קשר?", a: "לשאלות מהירות — השתמשו בצ'אטבוט ה-AI שלנו (הכפתור למטה). ליצירת קשר אנושית — שלחו מייל ל-reviewhub.il@gmail.com. מנויי מקצועי ופרימיום מקבלים מענה בעדיפות (תוך 4 שעות בימי עבודה)." },
            ].map(({ q, a }, i) => (
              <motion.div
                key={i}
                initial="hidden"
