      ...
      <section className="border-t border-border/50" id="faq">
        <div className="container py-20">
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            {[
              { q: "מה זה ReviewHub?", a: "ReviewHub היא תשתית האמון לכלכלה הדיגיטלית. אנחנו מאמתים כלי SaaS, מומחים דיגיטליים וקורסים מקצועיים — ומפיקים ציוני אמון המבוססים על נתוני מסחר ממשיים. לא על דעות, לא על פרסום בתשלום. ציון האמון אינו למכירה." },
              ...
              { q: "מה זה מערכת קישורי הרכישה המאומתת?", a: "קישורי רכישה מאומתת מאפשרים לכם לעקוב אחרי קליקים והמרות. כל קישור מגיע עם גילוי נאות מובנה — הגולש מבין שהרכישה עוברת דרך תשתית האימות של ReviewHub ומקנה לו סטטוס ״קונה מאומת״. ציון האמון אינו מושפע מהשתתפות בתוכנית. זמין מתוכנית מקצועי." },
