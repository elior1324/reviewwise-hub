        ...
        <div className="container py-20">
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            {[
              ...
              { q: "כמה עולה להירשם?", a: "יש תוכנית חינמית שכוללת פרופיל בסיסי, עד 10 ביקורות בחודש ותגובות. תוכניות מתקדמות: מקצועי (₪189/חודש) ופרימיום (₪479/חודש) עם פיצ'רים מתקדמים." },
