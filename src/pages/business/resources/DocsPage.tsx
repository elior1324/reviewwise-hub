...
**Rate Limiting**
- תוכנית Free: 100 קריאות ל-API לשעה
- תוכנית Pro: 1,000 קריאות לשעה
...
**מה ההבדל בין "חינמי" ל-"Pro"?**
תוכנית החינמית מוגבלת ל-10 ביקורות בחודש. Pro מסיר את המגבלה ומוסיף: בקשות ביקורת אוטומטיות, דוחות AI, Webhooks ועדיפות בתמיכה.
...
ב-Enterprise יש חיבור ישיר ל-HubSpot, Salesforce ו-Monday. בתוכניות אחרות ניתן להשתמש ב-Zapier עם טריגר מהוובהוק.
    `,
  },
];
