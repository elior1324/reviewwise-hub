      ...
      <div className="container py-12 max-w-4xl">
        <div className="space-y-12">
          ...
          <Section icon={Scale} title="אחריות והגבלות">
            ...
            <p>
              אתם תשפו אותנו ואת שותפינו מפני כל הפסד, עלות, הוצאה, תביעה או חבות הנובעים מ: (א) השימוש שלכם בשירותים; (ב) הפרת חוקי הפרטיות על ידכם; (ג) כל מעשה או מחדל שלכם הגורם להפרת נתונים; או (ד) כל תוכן שפרסמתם או העליתם לפלטפורמה.
            </p>
          </Section>
