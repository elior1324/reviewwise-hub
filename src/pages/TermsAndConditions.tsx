      ...
      <div className="container py-12 max-w-4xl">
        <div className="space-y-12">
          ...
          <Section icon={DollarSign} title="תוכנית שותפים (אפיליאט)">
            ...
            <ul className="list-disc pr-6 space-y-2 text-muted-foreground mb-4">
              <li><strong>עמלה לשותפים עסקיים:</strong> שותפים עסקיים רשומים מרוויחים 10% מהכנסות העסק על כל מכירה שבוצעה דרך קישור ההפניה שלהם. פרטי העמלה זמינים לשותפים רשומים בלבד.</li>
              <li><strong>עמלה לכותבי ביקורות מאומתות:</strong> משתמשים שכתבו ביקורת מאומתת מרוויחים עמלה בסיסית של 0.01% מכל רכישה שהגיעה בעקבות הביקורת שלהם. על כל 10 לייקים שהביקורת מקבלת, מתווסף עוד 0.01% — עד לתקרה מקסימלית של 1%.</li>
