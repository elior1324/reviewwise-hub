      ...
      <div className="container py-12 max-w-4xl">
        <div className="space-y-12">
          ...
          <Section icon={Handshake} title="קישורי רכישה דרך הפלטפורמה ועמלות תפעול">
            <p className="mb-3">
              במקרים מסוימים ReviewHub עשויה להפנות אתכם לאתרים של צדדים שלישיים באמצעות קישורי רכישה דרך הפלטפורמה. רכישות המתבצעות דרך קישורים אלה מתועדות בתשתית ReviewHub ומאפשרות לגולש לכתוב ביקורת לאחר הרכישה. עמלת תפעול עשויה להיווצר מרכישות אלו.
            </p>
            <p className="mb-3">
