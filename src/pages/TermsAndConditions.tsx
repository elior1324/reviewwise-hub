      ...
      <div className="container py-12 max-w-4xl">
        <div className="space-y-12">
          ...
          <Section icon={Scale} title="יישוב סכסוכים">
            ...
            <p>
              אתם ואנו מסכימים כי לבתי המשפט המוסמכים בתל אביב-יפו תהיה סמכות שיפוט בלעדית ליישב כל מחלוקת או תביעה הנובעת מתנאים אלה או הקשורה אליהם — ככל שהן נוגעות ליחסים בין המשתמש לבין ReviewHub בלבד — בהתאם לחוק בתי המשפט [נוסח משולב], התשמ"ד-1984.
            </p>
          </Section>
