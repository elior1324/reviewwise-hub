  ...
  <div className="min-h-screen bg-background noise-overlay" dir="rtl">
    ...
    <div className="container py-12 max-w-4xl">
      <div className="space-y-12">
        ...
        <Section icon={Handshake} title="קישורי רכישה מאומתת ועמלות תפעול">
          <p className="mb-3">
            במקרים מסוימים ReviewHub עשויה להפנות אתכם לאתרים של צדדים שלישיים באמצעות קישורי רכישה מאומתת. רכישות המתבצעות דרך קישורים אלה עוברות דרך תשתית האימות של ReviewHub ומקנות סטטוס ״קונה מאומת״ לגולש. עמלת תפעול עשויה להיווצר מרכישות אלו כדי לתמוך בתחזוקת תשתית האימות.
          </p>
          <p className="mb-3">
