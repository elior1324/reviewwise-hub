      ...
      <div className="space-y-12">
        ...
        <Section icon={Users} title="הצטרפות ושימוש ב-ReviewHub">
          ...
          <p className="mb-3">
            ...
            השירותים שלנו — חינם, ללא הגבלה וללא מנוי.
          </p>
          <p>
            ReviewHub שומרת לעצמה את הזכות לשנות את מודל התמחור בעתיד, עם הודעה מוקדמת למשתמשים.
          </p>
        </Section>
        ...
        <Section icon={CreditCard} title="שירות חינמי">
          <p className="mb-3">
            ReviewHub היא פלטפורמה חינמית לגמרי. אין תוכניות בתשלום, אין מנויים ואין חיובים כספיים.
        ...
        <Section icon={CreditCard} title="שירות חינמי — ללא ביטולים והחזרים">
          <p>
            ReviewHub היא פלטפורמה חינמית לגמרי. מאחר שאין חיובים כספיים, אין צורך בביטול עסקה או החזרים.
