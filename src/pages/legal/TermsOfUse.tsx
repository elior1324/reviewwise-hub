    ...
    <div className="container py-12 max-w-4xl">
      <div className="space-y-12">
        ...
        <Section icon={Handshake} title="קישורי הפניה ועמלות פלטפורמה">
          ...
          <p className="mb-3">
            <strong>גילוי נאות:</strong> כל קישור הפניה מסומן ומזוהה בצורה ברורה כקישור שותף לפני הלחיצה עליו.
            ReviewHub מחויבת לשקיפות מלאה בנושא זה.
          </p>
          <p className="mb-3">
            <strong>עצמאות ציון האמון:</strong> קיום יחסי אפיליאט עם עסק אינו משפיע בשום צורה על ציון האמון שלו.
            הציון מחושב אוטומטית מנתוני מסחר בלבד, ואינו ניתן לרכישה, שינוי או השפעה דרך שיתוף פעולה מסחרי.
          </p>
          <p className="mb-3">
