    ...
    <div className="container py-12 max-w-4xl">
      <div className="space-y-12">
        ...
        <Section icon={FileText} title="מבוא">
          ...
          <p className="mt-3">
            השימוש ב-ReviewHub חינמי לגמרי. עליכם לקבל תנאים אלה
          ...
          <p className="mt-3">
            ...
            (ב) תביעת עמוד פרופיל עסקי; או (ג) שימוש בכל אחד מהשירותים שלנו.
            השימוש בפלטפורמה חינמי לגמרי — אין מנויים ואין חיובים כספיים.
          </p>
        </Section>
        ...
        <Section icon={Users} title="הצטרפות ושימוש ב-ReviewHub">
          ...
          <p className="font-semibold text-foreground mb-2">שירות חינמי:</p>
          <p className="mb-3">
            על ידי תביעת עמוד פרופיל עסקי, תקבלו גישה לחשבון עסקי שדרכו תוכלו להשתמש בכל
            השירותים שלנו — חינם, ללא הגבלת זמן וללא מנוי. במקרה של שינוי עתידי במודל השירות,
            תקבלו הודעה בדוא״ל לפחות 30 ימים מראש.
          </p>
        </Section>
        ...
        {/* 8 — Pricing */}
        <Section icon={CreditCard} title="שירות חינמי">
          <p className="mb-3">
            ReviewHub היא פלטפורמה חינמית לגמרי, ללא הגבלת זמן. אין תוכניות בתשלום, אין מנויים ואין חיובים כספיים.
            כל הפיצ׳רים והכלים זמינים לכל משתמש רשום ללא עלות וללא הגבלה.
          </p>
          <p className="mb-3">
            ReviewHub שומרת לעצמה את הזכות לשנות את מודל התמחור או את היקף הפיצ׳רים בעתיד.
            במקרה של שינוי, תישלח הודעה בדוא״ל לכל בעלי העסקים הרשומים לפחות <strong>30 ימים מראש</strong>.
          </p>
          <p>
            המשך שימוש בפלטפורמה לאחר כניסת השינוי לתוקף מהווה הסכמה לתנאים המעודכנים.
          </p>
        </Section>
        ...
        <Section icon={Handshake} title="קישורי רכישה דרך הפלטפורמה ועמלות תפעול">
          <p className="mb-3">
            במקרים מסוימים ReviewHub עשויה להפנות אתכם לאתרים של צדדים שלישיים באמצעות קישורי רכישה דרך הפלטפורמה. רכישות המתבצעות דרך קישורים אלה מתועדות בתשתית ReviewHub ומאפשרות לגולש לכתוב ביקורת לאחר הרכישה. עמלת תפעול עשויה להיווצר מרכישות אלו כדי לתמוך בתחזוקת תשתית הפלטפורמה.
          </p>
          <p className="mb-3">
            <strong>גילוי נאות מלא:</strong> כל קישור רכישה מסומן ומזוהה בצורה ברורה לפני הלחיצה עליו, כולל הסבר על תשתית האימות ועל עמלת התפעול. ReviewHub מחויבת לשקיפות מלאה בנושא זה.
          </p>
          <p className="mb-3">
            <strong>עצמאות ציון האמון:</strong> קיום קישורי רכישה מאומתת עם עסק אינו משפיע בשום צורה על ציון האמון שלו. הציון מחושב אוטומטית מנתוני מסחר בלבד, ואינו ניתן לרכישה, שינוי או השפעה דרך שיתוף פעולה מסחרי. עמלות תפעול תומכות בתשתית האימות בלבד.
          </p>
          <p className="mb-3">
            <strong>עמלת התפעול שייכת לפלטפורמה בלבד.</strong> משתמשים ו/או כותבי ביקורות אינם זכאים לשום חלוקת הכנסה, תשלום או תגמול כספי מכל סוג.
          </p>
        </Section>
        ...
        <Section icon={AlertTriangle} title="סיום והשעיה">
          ...
          <ul className="list-disc pr-6 space-y-2 text-muted-foreground mb-4">
            <li><strong>מחיקת חשבון:</strong> תוכלו לסיים את השימוש בכל עת על ידי מחיקת חשבון העסק שלכם.</li>
          ...
          <ul className="list-disc pr-6 space-y-2 text-muted-foreground">
            <li><strong>סיום מיידי:</strong> הפרת תנאים מהותית, ביקורות מזויפות, או סיכון אבטחה.</li>
          </ul>
        </Section>
        ...
        <Section icon={Shield} title="פורטל ניהול מוניטין לעסקים">
          ...
          <div className="rounded-xl overflow-hidden border border-border/60 text-sm">
            {([
              ...
              ["השוואת מתחרים",           "השוואה אנונימית לציון אמון ממוצע בקטגוריה."],
            ] as [string, string][]).map(([k, v], i) => (
        ...
        {/* 16 — Free service note */}
        <Section icon={CreditCard} title="שירות חינמי — ללא ביטולים והחזרים">
          <p>
            ReviewHub היא פלטפורמה חינמית לגמרי, ללא הגבלת זמן. מאחר שאין חיובים כספיים, אין צורך בביטול עסקה או החזרים.
