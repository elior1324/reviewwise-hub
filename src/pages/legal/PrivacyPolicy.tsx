 ...
 * עומד ב: חוק הגנת הפרטיות התשמ"א-1981, תקנות אבטחת מידע התשע"ז-2017,
 *         תיקון 13 לחוק הגנת הפרטיות, GDPR Regulation 2016/679
 * נתיב: /privacy
 */
...
const SECTIONS = [
  {
    ...
    body: [
      ...
      { type: "list", items: [
        'חוק הגנת הפרטיות, התשמ"א-1981 ותקנותיו (כולל תיקון 13)',
  ...
  },
  {
    ...
    body: [
      ...
      { type: "list", items: [
        ...
        "תקשורת שירות — התראות על ביקורות חדשות, תגובות ועדכונים חיוניים על שינויים במודל השירות (לא שיווק). הודעות אלו נדרשות לצורך שימוש תקין בפלטפורמה",
  ...
  {
    id: "amendment13",
    title: "10. תיקון 13 לחוק הגנת הפרטיות",
    body: [
      { type: "p", text: "בהתאם לתיקון 13 לחוק הגנת הפרטיות (בתוקף מינואר 2025), ReviewHub פועלת לפי עקרונות הבאים:" },
      { type: "list", items: [
        "עיקרון צמידות המטרה — מידע אישי ישמש אך ורק למטרה שלגביה ניתנה הסכמת המשתמש",
        "פרטיות בעיצוב (Privacy by Design) — שיקולי פרטיות מוטמעים בכל תהליך פיתוח",
        "פרטיות כנקודת מוצא (Privacy by Default) — הגדרות ברירת המחדל הן הגדרות הפרטיות ביותר",
        "שקיפות מלאה — גילוי נאות על כל עיבוד מידע ומטרותיו",
      ]},
    ],
  },
  {
    id: "verification",
    title: "11. מנוע אימות לקוחות",
    body: [
      { type: "p", text: "ReviewHub מפעילה מערכת אימות דו-שכבתית המבחינה בין ביקורות אימות רכישה (שכבה א') למשוב קהילתי (שכבה ב')." },
      { type: "subtitle", text: "שכבת זהות — נדרשת לכל הביקורות:" },
      { type: "list", items: [
        "כל המשתמשים חייבים לאמת זהות דרך OAuth (Google / LinkedIn) לפני הגשת ביקורת.",
        "הגשות אנונימיות אינן מותרות בשום נסיבה.",
      ]},
      { type: "subtitle", text: "שכבת אימות רכישה (שכבה א'):" },
      { type: "list", items: [
        "סוגי הוכחה מקובלים: קבלת רכישה, חשבונית, אישור הרשמה, אישור תשלום, או רשומת עסקה.",
        "מסמכי הוכחה מאוחסנים בפרטיות ובהצפנה ואינם מוצגים בפומבי.",
        "נגישים פנימית ליישוב סכסוכים ולרשויות מוסמכות בלבד.",
        "ביקורות שכבה א' מוצגות עם תג אימות ותורמות לציון האמון.",
        "משוב קהילתי (שכבה ב') מוצג אך אינו משפיע על ציון האמון.",
      ]},
      { type: "subtitle", text: "הגנת זהות הסוקר:" },
      { type: "list", items: [
        "זהות הסוקר מאוחסנת בצורה מאובטחת ואינה מוצגת לציבור מעבר לשם המוצג שנבחר.",
        "מסמכי הוכחת רכישה מאוחסנים במאגר פרטי מוצפן — אינם נגישים לגופים מופיעים.",
        "נתונים אישיים ייחשפו לגוף, לרשות מוסמכת, או לבית משפט רק עם קבלת צו משפטי תקף.",
        "ביקורות ומטא-נתונים נשמרים כל עוד החשבון פעיל; מסמכי הוכחה נשמרים לאורך הביקורת בתוספת 3 שנים.",
        "סוקרים רשאים לבקש ייצוא נתוניהם בכל עת דרך פורטל הגדרות החשבון.",
        "סוקרים רשאים לבקש מחיקת ביקורותיהם ונתוניהם, בכפוף להגבלות משפטיות פעילות.",
      ]},
    ],
  },
  {
    id: "ai-moderation",
    title: "12. עיבוד אוטומטי ומידור AI",
    body: [
      { type: "p", text: "כל הגשות ביקורות עוברות עיבוד על ידי מערכת מידור אוטומטית לפני פרסום. המערכת פועלת על בסיס מיטב המאמצים ומשלימה (לא מחליפה) בדיקה אנושית של מקרים מסובכים." },
      { type: "subtitle", text: "היקף הזיהוי האוטומטי:" },
      { type: "list", items: [
        "שפה אסורה — גסויות, נאום שנאה, תוכן פוגעני קיצוני שאינו קשור למוצר.",
        "תקיפות אישיות — תוכן המכוון לתכונות אישיות של אנשים שאינן קשורות לחוויית המוצר.",
        "ספאם ותיאום — הגשות כפולות, חריגות בקצב הגשה, דפוסי מניפולציית ביקורות מתואמת.",
        "שידול מסחרי — ביקורות עם קישורי שותפים, קודי קידום, או שהועברו תמורת תגמול ללא גילוי.",
        "נתונים אישיים — תוכן הכולל בטעות פרטי צדדים שלישיים (שמות מלאים, פרטי קשר).",
      ]},
      { type: "subtitle", text: "מסגרת הפעולה:" },
      { type: "list", items: [
        "זוהתה שפה אסורה — ביקורת נחסמת; הסוקר מקבל הודעה עם אזכור מדיניות; רשאי לתקן ולהגיש מחדש.",
        "זוהתה תקיפה אישית — ביקורת מוחזרת עם הנחיות; ההגשה מושהית 24 שעות.",
        "אות ספאם — ביקורת מוחזקת לבדיקה ידנית; פעילות החשבון מסומנת לבדיקת Trust & Safety.",
        "שידול מסחרי — ביקורת נחסמת; הפרות חוזרות מביאות להשעיית חשבון.",
        "מקרה גבולי — ביקורת מפורסמת עם סימון פנימי ומועברת לביקורת אנושית תקופתית.",
      ]},
      { type: "p", text: "כל סוקר שהגשתו נחסמה רשאי לבקש בדיקה אנושית בפנייה לצוות Trust & Safety. בדיקות אנושיות מסתיימות תוך 5 ימי עסקים." },
    ],
  },
  {
    id: "changes",
