...
import {
  RotateCcw, FileText, CreditCard, Clock, Mail, AlertTriangle, Shield,
} from "lucide-react";
    ...
    <div className="container py-12 max-w-4xl">
      <div className="space-y-12">
        ...
        <Section icon={Shield} title="זכות ביטול עסקה — חוק הגנת הצרכן">
          <p className="mb-3">
            בהתאם לסעיף 14ג לחוק הגנת הצרכן, התשמ&quot;א-1981, ולתקנות הגנת הצרכן (ביטול
            עסקה), התשע&quot;א-2010, עומדת לכם הזכות לבטל עסקה בתנאים הבאים:
          </p>
          <div className="p-4 rounded-lg bg-primary/10 border border-primary/20 text-foreground mb-4">
            ...
            <p>
              רשאים לבטל את העסקה{" "}
              <strong>
                תוך 14 ימים מיום ביצוע העסקה או מיום קבלת מסמך הגילוי
              </strong>{" "}
              (המאוחר מביניהם), ובתנאי שלא החלתם לעשות שימוש בשירות.
            </p>
          </div>
          <ul className="list-disc pr-6 space-y-2 text-muted-foreground">
            <li>
              <strong>תקופת ביטול:</strong> 14 ימים מיום ביצוע העסקה או מיום קבלת פרטי
              העסקה בכתב — לפי המאוחר.
            </li>
            <li>
              <strong>אזרח ותיק / אדם עם מוגבלות / עולה חדש:</strong> זכאים לביטול תוך{" "}
              <strong>4 חודשים</strong> מיום ביצוע העסקה — לפי המאוחר, ובלבד שההתקשרות
              כללה שיחה בין הצדדים.
            </li>
          </ul>
        </Section>
        ...
        <Section icon={AlertTriangle} title="מקרים מיוחדים">
          <ul className="list-disc pr-6 space-y-2 text-muted-foreground mb-4">
            <li>
              <strong>תקלה טכנית:</strong> אם לא הצלחתם להשתמש בשירות עקב תקלה טכנית שלנו —
              תהיו זכאים להחזר מלא עבור התקופה המושפעת.
            </li>
            <li>
              <strong>חיוב שגוי:</strong> במקרה של חיוב כפול או שגוי, פנו אלינו ונתקן ונחזיר
              את הסכום תוך 7 ימי עסקים.
            </li>
            <li>
              <strong>הפסקת שירות על ידי ReviewHub:</strong> אם ReviewHub מפסיקה שירות
              בתשלום, יינתן החזר יחסי עבור התקופה שלא סופקה.
            </li>
          </ul>
        </Section>

        {/* 8 — Non-refundable */}
        <Section icon={CreditCard} title="שירותים ומוצרים שאינם ניתנים להחזר">
          <ul className="list-disc pr-6 space-y-2 text-muted-foreground">
            <li>
              <strong>שירותים שנוצלו במלואם:</strong> שירות שהושלם לחלוטין, כגון דו&quot;ח
              חד-פעמי שהופק וסופק — אינו ניתן לביטול לאחר מסירתו.
            </li>
            <li>
              <strong>תוכן דיגיטלי שהורד:</strong> בהתאם לחוק, תוכן דיגיטלי שהושלמה הגישה
              אליו אינו ניתן לביטול.
            </li>
            <li>
              <strong>תשלומים לשותפים:</strong> עמלות ששולמו במסגרת תוכנית השותפים אינן
              ניתנות להחזר.
            </li>
          </ul>
        </Section>
