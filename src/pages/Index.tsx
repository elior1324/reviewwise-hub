        ...
        <div className="container py-20">
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            {[
              ...
              { q: "אפשר לכתוב ביקורת בעילום שם?", a: "כן! בעת כתיבת ביקורת תוכלו לסמן \"ביקורת אנונימית\" — גם אם אימתתם רכישה עם קבלה או חשבונית. שמכם לא יוצג, אבל תג ה-✅ \"רכישה מאומתת\" עדיין יופיע כדי לשמור על אמינות הביקורת." },
