        ...
        <div className="container py-20">
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            {[
              ...
              { q: "מה זה תוכנית השותפים (אפיליאט)?", a: "כשתכתבו ביקורת מאומתת, אתם מתחילים להרוויח 0.01% מכל רכישה שמגיעה בזכותכם. על כל 10 לייקים שהביקורת מקבלת — מתווסף עוד 0.01%, עד מקסימום 1%. ככל שהביקורת שלכם איכותית יותר — ההכנסה שלכם גדלה!" },
