...
// widget-data is intentionally public: it is embedded on external business
// websites via <script> / iframe and carries no user credentials.
// "*" is correct here — do not replace with getCorsHeaders().
const corsHeaders = {
...
<a href="${profileUrl}" target="_blank" rel="noopener" class="rh-widget">
  ...
  <div class="rh-info">
    ...
    console.error("[widget-data] unhandled error:", err);
